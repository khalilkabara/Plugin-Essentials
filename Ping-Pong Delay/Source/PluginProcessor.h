...
public:
	...
	const String balanceParamName{ "balance" };
	const String delayTimeParamName{ "delayTime" };
	const String feedbackParamName{ "feedback" };
	const String mixParamName{ "mix" };

	const String allowedFileFormat = "*.wpd";
	const String presetExtension = ".wpd";
