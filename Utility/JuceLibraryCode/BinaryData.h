...
namespace BinaryData
{
    ...
    extern const char*   tremoloBackground_png;
    const int            tremoloBackground_pngSize = 65490;

    extern const char*   utilityBackground_png;
    const int            utilityBackground_pngSize = 65490;

    extern const char*   wahWahBackground_png;
    const int            wahWahBackground_pngSize = 65490;
